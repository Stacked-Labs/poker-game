...
test('Crypto game: both players check/call through all streets — hand completes, new hand starts', async ({
    cryptoPlayerA,
    cryptoPlayerB,
}) => {
    ...
    // Flop, turn, river: two checks each
