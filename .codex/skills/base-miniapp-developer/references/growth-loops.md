...
6. **[S] Builder Code (ERC-8021) + Base.dev game listing.** Claim on Base.dev; append the data-suffix to deposit/join/settle calls → App Leaderboard featuring + Builder Rewards (helps cold-start discovery). See `manifest-and-registration.md`.
