    ...
    return (
        <ConnectButton
            ...
            detailsButton={{
                ...
                // Show USDC balance for the default (first enabled) chain
                displayBalanceToken: {
                    [defaultChain.id]: CHAIN_CONFIG[enabledChains[0] ?? 'base-sepolia'].usdc,
                },
            }}
            detailsModal={{
                payOptions: {
                    prefillBuy: {
                        token: {
                            address: CHAIN_CONFIG[enabledChains[0] ?? 'base-sepolia'].usdc,
                            name: 'USD Coin',
                            symbol: 'USDC',
                            icon: '/usdc-logo.png',
                        },
